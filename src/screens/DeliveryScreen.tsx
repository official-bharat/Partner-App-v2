    ...
    return (
      <TouchableOpacity
        ...
        <List.Item
          ...
          left={(props) => <DeliveryIcon status={this.state.status} />}
        />
      </TouchableOpacity>
    );
  };
    ...
    return (
      <View style={CommonStyles.container}>
        <Appbar.Header theme={HeaderTheme}>
          <Appbar.Content
            title={CommonUtils.translateMessageCode('deliveryRequests')}
...
class DeliveryIcon extends React.Component<any, {status: string}> {
  constructor(props: Readonly<any>) {
    super(props);
    this.state = {
